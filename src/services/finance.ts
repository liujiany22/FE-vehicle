...
export const addAdvance = (data: { vehicle_id: number, amount: number, advance_time: string}) => {
...
export const updateAdvance = (data: { advance_id: number, vehicle_id?: number, amount?: number, advance_time?: string }) => {
